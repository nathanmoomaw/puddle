...
var ICONS = {
  add: async () => (await import("./add-PKUWE47P.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-SAVWAYQL.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-5ORV3MCJ.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-LLC7DYTL.js")).appStoreSvg,
  apple: async () => (await import("./apple-VSMDA2D4.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-Q4T5U63T.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-QYEVV7H3.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-RO534IVN.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-PLZ742FN.js")).arrowTopSvg,
  bank: async () => (await import("./bank-GQLZ2SQZ.js")).bankSvg,
  browser: async () => (await import("./browser-47R5VOSA.js")).browserSvg,
  card: async () => (await import("./card-FGW7S7CS.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-CEDRKDHI.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-EN5GVL4O.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-YKVXGEVR.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-4T6PURCV.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-XN77ARPA.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-K2GOEOKL.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-4VNAJ6ZY.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-WTN4ZPL5.js")).clockSvg,
  close: async () => (await import("./close-CJL7BTYB.js")).closeSvg,
  compass: async () => (await import("./compass-2DS4HJOF.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-33MKFE66.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-AHMNMCRW.js")).copySvg,
  cursor: async () => (await import("./cursor-LIOP4FZN.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-EVQO6ZVN.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-QUAYE4DE.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-QFZJ2IUR.js")).disconnectSvg,
  discord: async () => (await import("./discord-Z2EXNZCK.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-XBG4II4F.js")).etherscanSvg,
  extension: async () => (await import("./extension-IFQPPKKQ.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-64LCXOCS.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-NKQFQ5JY.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-IACLA6EO.js")).farcasterSvg,
  filters: async () => (await import("./filters-7UXJVWSO.js")).filtersSvg,
  github: async () => (await import("./github-U437NOC3.js")).githubSvg,
  google: async () => (await import("./google-OUQSEDSW.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-IAMNXAQX.js")).helpCircleSvg,
  image: async () => (await import("./image-PO7XQLTE.js")).imageSvg,
  id: async () => (await import("./id-55TOONYB.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-NAEB4COQ.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-DA52LPEV.js")).lightbulbSvg,
  mail: async () => (await import("./mail-3LHKBIHX.js")).mailSvg,
  mobile: async () => (await import("./mobile-U6KEN5VA.js")).mobileSvg,
  more: async () => (await import("./more-U4VRP4AV.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-VNQJV63J.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-GDIEJKVO.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-JP6MVNZ4.js")).offSvg,
  playStore: async () => (await import("./play-store-Z5DBV6X3.js")).playStoreSvg,
  plus: async () => (await import("./plus-HYKW76WX.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-WFDEWX6B.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-7DLBFG2A.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-YBSDCLTK.js")).refreshSvg,
  search: async () => (await import("./search-LWP7AHMR.js")).searchSvg,
  send: async () => (await import("./send-D5LBCRW6.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-JDBBQCRB.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-5MIMVMLT.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-3O2U2AXM.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-SO2MZLKM.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-D2P4SGSN.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-F25GWV3M.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-4QS5CGVG.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-DMHQI3IK.js")).twitchSvg,
  twitter: async () => (await import("./x-PALJQV5U.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-JRMV2DZG.js")).twitterIconSvg,
  verify: async () => (await import("./verify-6CAD6RNU.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-HAKDJHLW.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-FJXGYDC7.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-ET7LPWWK.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-ET7LPWWK.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-ET7LPWWK.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-EKUPT3YS.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-DVIMQZKM.js")).warningCircleSvg,
  x: async () => (await import("./x-PALJQV5U.js")).xSvg,
  info: async () => (await import("./info-O4QZCIGF.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-COC6MSTB.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-YK4M6U4E.js")).reownSvg
};
...
//# sourceMappingURL=chunk-4YRJRX23.js.map
