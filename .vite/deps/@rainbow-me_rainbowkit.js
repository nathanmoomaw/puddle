...
import {
  en_US_default
} from "./chunk-34DSGL6C.js";
import {
  ens_normalize
} from "./chunk-MEVU7KOM.js";
import {
  __assign,
  __rest,
  __spreadArray,
...
} from "./chunk-HFG3SNWU.js";
import {
  require_browser
} from "./chunk-KIFX3E4E.js";
import "./chunk-P7N2IIWL.js";
import "./chunk-ONQR7BQQ.js";
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-TAXN6E7A.js";
import "./chunk-FKIXUHB7.js";
import {
  require_react_dom
} from "./chunk-H6UMEMXN.js";
import {
...
import {
  ...
  utf8ToBytes,
  validateObject
} from "./chunk-BQV2HLTS.js";
import {
  useQuery
} from "./chunk-63AHCIFJ.js";
import {
  require_jsx_runtime
} from "./chunk-MBD4MS7N.js";
import {
  require_react
} from "./chunk-NMBIJXSC.js";
import {
  __commonJS,
  __toESM
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-2P344Y7Y.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-CS2HVNR6.js");
    ...
    async getProvider() {
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-B2SWPWPH.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-LAOUPMRE.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-ETFB6YJ5.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-NMSUEW6F.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-P4E2SFGF.js");
...
var fetchTranslations = async (locale) => {
  switch (locale) {
    case "ar":
    case "ar-AR":
      return (await import("./ar_AR-44JUQ6EW-YCNFJ4LL.js")).default;
    case "de":
    case "de-DE":
      return (await import("./de_DE-PYAO5YD6-4NZPMBOG.js")).default;
    case "en":
    case "en-US":
      return (await import("./en_US-Y4ZOVFV4-4FI5CGRY.js")).default;
    case "es":
    case "es-419":
      return (await import("./es_419-HRGOJ6VT-UDAA4I74.js")).default;
    case "fr":
    case "fr-FR":
      return (await import("./fr_FR-IGGVC6RM-4I35ZMHN.js")).default;
    case "hi":
    case "hi-IN":
      return (await import("./hi_IN-XSKAA3MF-YMQBXIVY.js")).default;
    case "id":
    case "id-ID":
      return (await import("./id_ID-KUOB4UAL-RZXDITST.js")).default;
    case "ja":
    case "ja-JP":
      return (await import("./ja_JP-4WRQ63RX-PUXIAFC7.js")).default;
    case "ko":
    case "ko-KR":
      return (await import("./ko_KR-I2K7AIEP-USYPE7Y4.js")).default;
    case "ms":
    case "ms-MY":
      return (await import("./ms_MY-6VZW6Q3Z-KSPF64EK.js")).default;
    case "pt":
    case "pt-BR":
      return (await import("./pt_BR-N3XOZ4SV-YXHBH4II.js")).default;
    case "ru":
    case "ru-RU":
      return (await import("./ru_RU-IITAPRET-TISJVN7A.js")).default;
    case "th":
    case "th-TH":
      return (await import("./th_TH-3ZQCKCQE-DZDW5ECA.js")).default;
    case "tr":
    case "tr-TR":
      return (await import("./tr_TR-QUPUGMUF-JSLTJTS6.js")).default;
    case "ua":
    case "uk-UA":
      return (await import("./uk_UA-SSN6SV5E-NXBWB4XU.js")).default;
    case "vi":
    case "vi-VN":
      return (await import("./vi_VN-7BUVRNYY-7MYBHLDU.js")).default;
    case "zh":
    case "zh-CN":
    case "zh-Hans":
      return (await import("./zh_CN-HJBN674C-4CWKR67U.js")).default;
    case "zh-HK":
      return (await import("./zh_HK-JW3WLRKE-DZHEU2TR.js")).default;
    case "zh-Hant":
    case "zh-TW":
      return (await import("./zh_TW-VNNRNXY7-EX737EAY.js")).default;
    default:
      return (await import("./en_US-Y4ZOVFV4-4FI5CGRY.js")).default;
  }
};
...
var apeChainIcon = {
  ...
  iconUrl: async () => (await import("./apechain-SX5YFU6N-6POEGWVB.js")).default
};
var arbitrumIcon = {
  iconBackground: "#96bedc",
  iconUrl: async () => (await import("./arbitrum-WURIBY6W-3L4AKD3L.js")).default
};
var avalancheIcon = {
  iconBackground: "#e84141",
  iconUrl: async () => (await import("./avalanche-KOMJD3XY-Z6HE37ZH.js")).default
};
var baseIcon = {
  iconBackground: "#0052ff",
  iconUrl: async () => (await import("./base-OAXLRA4F-7WJ362D5.js")).default
};
var berachainIcon = {
  iconBackground: "#814625",
  iconUrl: async () => (await import("./berachain-NJECWIVC-63WBEJRP.js")).default
};
var blastIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./blast-V555OVXZ-4ZUS7FLU.js")).default
};
var bscIcon = {
  iconBackground: "#ebac0e",
  iconUrl: async () => (await import("./bsc-N647EYR2-4VSIFKM3.js")).default
};
var celoIcon = {
  iconBackground: "#FCFF52",
  iconUrl: async () => (await import("./celo-GEP4TUHG-HCC5G4TV.js")).default
};
var cronosIcon = {
  iconBackground: "#002D74",
  iconUrl: async () => (await import("./cronos-HJPAQTAE-5NUHEC4M.js")).default
};
var degenIcon = {
  iconBackground: "#A36EFD",
  iconUrl: async () => (await import("./degen-FQQ4XGHB-HK7LZXLR.js")).default
};
var ethereumIcon = {
  iconBackground: "#484c50",
  iconUrl: async () => (await import("./ethereum-RGGVA4PY-SCRNNIBD.js")).default
};
var flowIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./flow-5FQJFCTK-53ZKGPBJ.js")).default
};
var gnosisIcon = {
  iconBackground: "#04795c",
  iconUrl: async () => (await import("./gnosis-37ZC4RBL-UXRCZSOF.js")).default
};
var gravityIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./gravity-J5YQHTYH-BVSUS3XK.js")).default
};
var hardhatIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./hardhat-TX56IT5N-BEQFLWPC.js")).default
};
var hyperevmIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./hyperevm-VKPAA4SA-D6ML7VCT.js")).default
};
var inkIcon = {
  iconBackground: "#7132F5",
  iconUrl: async () => (await import("./ink-FZMYZWHG-7VHYPSKD.js")).default
};
var kaiaIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./kaia-65D2U3PU-KXBI6HFW.js")).default
};
var lineaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./linea-QRMVQ5DY-4XOXL3IK.js")).default
};
var mantaIcon = {
  iconBackground: "#ffffff",
  iconUrl: async () => (await import("./manta-SI27YFEJ-ZSCCVMXE.js")).default
};
var mantleIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./mantle-CKIUT334-JJCVSGGN.js")).default
};
var monadTestnetIcon = {
  iconBackground: "transparent",
  iconUrl: async () => (await import("./monad-4KWC6TSS-MUPNR2SU.js")).default
};
var optimismIcon = {
  iconBackground: "#ff5a57",
  iconUrl: async () => (await import("./optimism-HAF2GUT7-EFJCDGXO.js")).default
};
var polygonIcon = {
  iconBackground: "#9f71ec",
  iconUrl: async () => (await import("./polygon-WW6ZI7PM-BKE3YCA5.js")).default
};
var roninIcon = {
  iconBackground: "#1273EA",
  iconUrl: async () => (await import("./ronin-EMCPYXZT-U255OCXY.js")).default
};
var sankoIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./sanko-RHQYXGM5-IDRCBVYM.js")).default
};
var superpositionIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./superposition-HG6MMR2Y-K26VNQPH.js")).default
};
var scrollIcon = {
  iconBackground: "#FFEEDA",
  iconUrl: async () => (await import("./scroll-5OBGQVOV-HXRRZJOI.js")).default
};
var unichainIcon = {
  iconBackground: "#F50DB4",
  iconUrl: async () => (await import("./unichain-C5BWO2ZY-IE7H7OIS.js")).default
};
var xdcIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./xdc-KJ3TDBYO-5ZLY7MJD.js")).default
};
var zetachainIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zetachain-TLDS5IPW-32ITDRIH.js")).default
};
var zkSyncIcon = {
  iconBackground: "#f9f7ec",
  iconUrl: async () => (await import("./zksync-DH7HK5U4-BYEMU3GM.js")).default
};
var zoraIcon = {
  iconBackground: "#000000",
  iconUrl: async () => (await import("./zora-FYL5H3IO-VOK3CGDZ.js")).default
};
...
var src = async () => (await import("./assets-Q6ZU7ZJ5-GCFFUQTS.js")).default;
...
var src2 = async () => (await import("./login-UP3DZBGS-7FWAKPV2.js")).default;
...
var signInIcon = async () => (await import("./sign-A7IJEUT5-NLEE7R6D.js")).default;
function SignIn({
  onClose,
  onCloseModal
}) {
...
var src3 = async () => (await import("./connect-UA7M4XW6-23PX7GIJ.js")).default;
...
var src4 = async () => (await import("./create-FASO7PVG-46HHFVHA.js")).default;
...
var src5 = async () => (await import("./refresh-S4T5V5GX-PUKNKEN6.js")).default;
...
var src6 = async () => (await import("./scan-4UYSQ56Q-XFOTLRJN.js")).default;
...
var getBrowserSrc = async () => {
  ...
  switch (browser) {
    case "Arc":
      return (await import("./Arc-VDBY7LNS-UVI2QX2U.js")).default;
    case "Brave":
      return (await import("./Brave-BRAKJXDS-VJCAYFS4.js")).default;
    case "Chrome":
      return (await import("./Chrome-65Q5P54Y-EA7EH4JS.js")).default;
    case "Edge":
      return (await import("./Edge-XSPUTORV-YVEBSRS3.js")).default;
    case "Firefox":
      return (await import("./Firefox-AAHGJQIP-LF7FC3JN.js")).default;
    case "Opera":
      return (await import("./Opera-KQZLSACL-WBNTJANY.js")).default;
    case "Safari":
      return (await import("./Safari-ZPL37GXR-NQ6SB6HD.js")).default;
    default:
      return (await import("./Browser-76IHF3Y2-JATV7GOJ.js")).default;
  }
};
...
var getPlatformSrc = async () => {
  ...
  switch (platform) {
    case "Windows":
      return (await import("./Windows-PPTHQER6-MK3BIMXX.js")).default;
    case "macOS":
      return (await import("./Macos-MW4AE7LN-X2BV6OQG.js")).default;
    case "Linux":
      return (await import("./Linux-OO4TNCLJ-I3YF73TO.js")).default;
    default:
      return (await import("./Linux-OO4TNCLJ-I3YF73TO.js")).default;
  }
};
...
var baseAccount2 = ({
  ...
  return {
    ...
    rdns: "app.base.account",
    iconUrl: async () => (await import("./baseAccount-44UITRK7-RHZODHH4.js")).default,
    iconAccent: "#0000FF",
...
var metaMaskWallet = ({
  ...
  return {
    ...
    name: "MetaMask",
    rdns: "io.metamask",
    iconUrl: async () => (await import("./metaMaskWallet-SITXT2FV-QDUBW5UD.js")).default,
    iconAccent: "#f6851a",
    iconBackground: "#fff",
...
var rainbowWallet = ({
  ...
  return {
    ...
    name: "Rainbow",
    rdns: "me.rainbow",
    iconUrl: async () => (await import("./rainbowWallet-O26YNBMX-LATGSVD7.js")).default,
...
var safeWallet = () => ({
  ...
  iconAccent: "#12ff80",
  iconBackground: "#fff",
  iconUrl: async () => (await import("./safeWallet-5MNKTR5Z-WRSHB2CB.js")).default,
  installed: (
...
var walletConnectWallet = ({
  ...
  return {
    ...
    name: "WalletConnect",
    installed: void 0,
    iconUrl: async () => (await import("./walletConnectWallet-YHWKVTDY-XD25PHFG.js")).default,
